...
return [
    ...
    'Enter the six-digit code from your app to disable 2FA' => 'Введите шестизначный код из вашего приложения для отключения 2FA',
    'You can use Google Authenticator or another 2FA application. If you do not have any, you can download Google Authenticator in {apple} or {google}.' => 'Вы можете использовать Google Authenticator или другое 2FA приложение. Если у вас не установлено, можете установить Google Authenticator в {apple} или {google}.',
    'If you can\'t scan the image, enter the code manually: {code}' => 'Если вы не можете просканировать изображение, можете ввести код: {code}',
    'Enter the six-digit code below' => 'Введите шестизначный код ниже',
    ...
    'Please enter the six-digit code from your app' => 'Пожалуйста введите шестизначный код с вашего приложения',
